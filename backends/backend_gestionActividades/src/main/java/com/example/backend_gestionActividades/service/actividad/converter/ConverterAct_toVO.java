...
@Component
public class ConverterAct_toVO implements Converter<ActividadDTO, ActividadVO> {

    @Override
    public ActividadVO convert(ActividadDTO actividad) {
        return ActividadVO.builder()
                .id(actividad.getId())
